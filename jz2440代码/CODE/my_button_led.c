...
static int sixth_drv_open(struct inode *inode,struct file *file)
{
	...
	request_irq(IRQ_EINT0,buttons_irq,IRQT_FALLING,"s2",&pins_desc[0]);
	request_irq(IRQ_EINT2,buttons_irq,IRQT_FALLING,"s3",&pins_desc[1]);
	request_irq(IRQ_EINT11,buttons_irq,IRQT_FALLING,"s4",&pins_desc[2]);
	request_irq(IRQ_EINT19,buttons_irq,IRQT_FALLING,"s5",&pins_desc[3]);
